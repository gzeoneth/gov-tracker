...
import { wrapText, getStages, buildBreadcrumb } from "../utils/index.js";
...
export function SimulationView({
  ...
  const breadcrumb = buildBreadcrumb(proposal, "Simulation");

  if (simulations.length === 0) {
    return (
      <ViewLayout view="simulation" title="Simulation Data" loading={loading} loadingText="Extracting simulations..." error={error} breadcrumb={breadcrumb}>
